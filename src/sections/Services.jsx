...
export default function Services() {
  ...
  return (
    <section id="services-section" className="min-h-96 md:pl-5 px-6 overflow-hidden mb-0 mt-10 flex flex-col" aria-label="Our Services">
      <div className="relative flex-2 flex flex-col lg:flex-row gap-4">
        <article className="md:ml-10 flex-1 font-family-lato flex justify-center flex-col">
          <header>
        ...
        <aside id="container-bars" className="relative flex justify-center -z-10 flex-1 pointer-events-none overflow-hidden">
          <span className="hidden lg:block absolute bottom-0 right-0 top-0 h-10 bg-black w-lg" aria-hidden="true"></span>
          <span className="hidden lg:block absolute transform top-4/11 right-0 h-27 bg-black w-md" aria-hidden="true"></span>
          <span className="hidden lg:block absolute bottom-0 right-0 h-6 bg-black w-lg" aria-hidden="true"></span>
          <div className="relative lg:absolute bottom-0 right-0 object-cover">
            <img src="../../images/face-services.png" className="grayscale mask-b-from-60%" alt="Professional representing our service quality and expertise" />
          </div>
        </aside>
      </div>
    </section >
