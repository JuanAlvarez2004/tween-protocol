...
export default function About() {
  ...
  return (
    <section id="about-section" className="relative h-300px md:h-dvh flex flex-col gap-8 md:gap-0 md:flex-row mt-10 sm:my-2 lg:px-14 overflow-hidden select-none" aria-label="About Tween Protocol">
      <article className="flex-1 px-4 lg:px-8">
        <div id="about-part-1" className="h-full flex flex-col justify-center md:justify-start">
          <div id="about-part-1-text" className="p-0 md:p-3 text-center md:text-balance flex-none h-auto md:h-60 lg:h-50 flex justify-center items-center">
          ...
          <div className="hidden md:block w-full shrink contrast-150">
            <img src="../../images/part-1-about.jpg" className="object-cover w-full h-full grayscale" alt="Minimalist urban design concept representing our approach" />
          </div>
        </div>
      </article>
      <article className="flex-1 px-4 lg:px-8 z-20">
        <div id="about-part-2" className="h-80 md:h-full relative">
          ...
          <div className="w-full h-full opacity-95 md:opacity-100 md:contrast-150">
            <img src="../../images/part-2-about.jpg" className="object-cover w-full h-full grayscale" alt="Creative workspace representing our digital studio environment" />
          </div>
        </div>
      </article>
      <article className="flex-1 px-4 lg:px-8">
        <div id="about-part-3" className="relative h-full flex flex-col justify-center md:justify-start">
          <div id="about-part-3-text" className="p-0 md:p-3 text-center md:text-balance flex-none h-auto md:h-60 lg:h-50 flex justify-center items-center">
          ...
          <div className="hidden md:block w-full shrink contrast-150 -z-10">
            <img src="../../images/part-3-about.jpg" className="object-cover w-full h-full grayscale" alt="Innovation and creativity concept in digital design" />
          </div>
        </div>
      </article>
    </section>
